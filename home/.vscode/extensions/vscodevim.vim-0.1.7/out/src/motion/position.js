...
class Position extends vscode.Position {
    ...
    static *IterateLine(vimState, options = { reverse: false }) {
        ...
        const topLeft = modeVisualBlock_1.VisualBlockMode.getTopLeftPosition(start, stop);
        const bottomRight = modeVisualBlock_1.VisualBlockMode.getBottomRightPosition(start, stop);
...
Position.NonWordCharacters = configuration_1.Configuration.getInstance().iskeyword;
