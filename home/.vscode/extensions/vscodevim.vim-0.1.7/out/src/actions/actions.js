...
let CommandStar_1 = class CommandStar extends BaseCommand {
    constructor(...args) {
        super(...args);
        this.modes = [mode_1.ModeName.Normal, mode_1.ModeName.Visual, mode_1.ModeName.VisualLine];
        this.keys = ["*"];
...
let CommandHash = class CommandHash extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let text = textEditor_1.TextEditor.getText(new vscode.Range(vimState.cursorPosition, vimState.cursorPosition.getRight()));
            if (text === " ") {
                return vimState;
            }
            // hack end
...
let CommandSearchForwards = class CommandSearchForwards extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            vimState.searchState = new modeHandler_1.SearchState(modeHandler_1.SearchDirection.Forward, vimState.cursorPosition);
...
let CommandSearchBackwards = class CommandSearchBackwards extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            vimState.searchState = new modeHandler_1.SearchState(modeHandler_1.SearchDirection.Backward, vimState.cursorPosition);
            vimState.currentMode = mode_1.ModeName.SearchInProgressMode;
            return vimState;
        });
    }
...
let MoveToViewPortCenter = class MoveToViewPortCenter extends MoveScreenLineBegin {
    constructor(...args) {
        super(...args);
        this.modes = [mode_1.ModeName.Normal, mode_1.ModeName.Visual, mode_1.ModeName.VisualLine];
        this.keys = ["M"];
...
MoveToViewPortCenter = __decorate([
    RegisterAction
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const { start, end } of position_1.Position.IterateLine(vimState, { reverse: true })) {
                vimState = yield new DeleteOperator().run(vimState, start, end);
            }
            vimState.cursorPosition = position;
            return vimState;
        });
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const { start, end } of position_1.Position.IterateLine(vimState)) {
                yield deleteOperator.delete(start, end, vimState.currentMode, vimState.effectiveRegisterMode(), vimState, true);
            }
            vimState.currentMode = mode_1.ModeName.VisualBlockInsertMode;
            vimState.recordedState.visualBlockInsertionType = modeVisualBlock_1.VisualBlockInsertionType.Insert;
            return vimState;
...
class IncrementDecrementNumberAction extends BaseMovement {
    constructor(...args) {
        super(...args);
        this.modes = [mode_1.ModeName.Normal];
        this.canBePrefixedWithCount = true;
